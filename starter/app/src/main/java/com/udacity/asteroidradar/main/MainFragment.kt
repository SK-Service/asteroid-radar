...
class MainFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        //Set Picture of day Content Description
        if (mainViewModel.picOfDayProperty.value?.title != null ) {
            binding.activityMainImageOfTheDay.contentDescription = "This is the picture of the day " +
                    "retrieved from NASA. This is " +
                    "${mainViewModel.picOfDayProperty.value?.title}"
        }
